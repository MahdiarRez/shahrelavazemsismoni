...
// مدیریت انتخاب پیش‌فرض Variation
watchEffect(() => {
						...
						<div class="flex gap-2 mt-2 mb-4 flex-wrap">
							<label
								...
								<span
									...
									:title="`Color: ${variation.attributes.nodes
										.map((attr) => attr.value)
										.toString()}`">
									{{
...
.button-bezel {
	...
	@apply bg-secondary-600 outline-none tracking-[-0.125px] transition scale-[var(--button-scale,1)] duration-200;
	&:hover {
