...
const selectedSort = ref(
	!route.query.orderby && !route.query.fieldby
		? "Newest"
		: route.query.orderby === "DESC" && route.query.fieldby === "PRICE"
		? "Price: High to Low"
		: "Price: Low to High",
);
...
<template>
	<div
		...
		<div
			...
			:class="{
				'bg-black text-white hover:bg-black dark:bg-white dark:text-black hover:dark:bg-white':
					isDropdownVisible,
				'bg-[#efefef] hover:bg-[#e2e2e2] dark:bg-[#262626] hover:dark:bg-[#333]':
					!isDropdownVisible,
			}">
			<UIcon
		...
		<Transition name="dropdown">
			<div
				...
				class="absolute top-full left-0 z-10 mt-3 lg:mt-[18px] rounded-2xl text-base font-semibold bg-white dark:bg-[#262626] border border-solid border-secondary dark:border-secondary-300 shadow-[0_0_8px_rgba(0,0,0,.3)]">
				<div class="m-2 w-48">
					<div
						...
						<div
							...
							<div class="mr-1 w-full text-right">
								{{ option.label }}
							</div>
							<UIcon
