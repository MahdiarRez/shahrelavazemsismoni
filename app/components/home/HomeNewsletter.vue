...
const MAP_EMBED_URL =
	"https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d4851.480172178447!2d59.667809253711354!3d36.307700070933976!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2s!4v1757600094220!5m2!1sen!2s";
...
<template>
	<section
		id="shop"
		class="relative py-32 mt-14 bg-white text-dark px-6">
		<img
			src="/people.png"
			alt="people"
			class="absolute inset-0 h-full w-full object-cover opacity-40 blur-[1px] rounded-[28px]"
			loading="lazy" />
		...
		<div class="max-w-6xl mx-auto relative">
			...
			<div class="grid lg:grid-cols-2 gap-12">
				...
				<div
					...
					<!-- Map Container -->
					<div
						class="relative h-96 bg-gradient-to-br from-pink-50 to-blue-50 rounded-2xl overflow-hidden">
						<iframe
							v-if="activeTab === 'map'"
							:src="MAP_EMBED_URL"
							width="100%"
					...
					<!-- Features -->
					<div
						class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-center">
						<div
							v-for="feature in STORE_FEATURES"
							:key="feature.label"
