...
declare module '@nuxt/schema' {
  interface ModuleDependencies {
    ["nuxt-graphql-request"]?: ModuleDependencyMeta<typeof import("nuxt-graphql-request").default extends NuxtModule<infer O> ? O : Record<string, unknown>>
  ...
  interface NuxtOptions {
    /**
     * Configuration for `nuxt-graphql-request`
     */
    ["graphql"]: typeof import("nuxt-graphql-request").default extends NuxtModule<infer O, unknown, boolean> ? O : Record<string, any>
    /**
  ...
  interface NuxtConfig {
     ...
     * Configuration for `nuxt-graphql-request`
     */
    ["graphql"]?: typeof import("nuxt-graphql-request").default extends NuxtModule<infer O, unknown, boolean> ? Partial<O> : Record<string, any>
    /**
     * Configuration for `@vueuse/nuxt`
     */
    ...
    modules?: (undefined | null | false | NuxtModule<any> | string | [NuxtModule | string, Record<string, any>] | ["nuxt-graphql-request", Exclude<NuxtConfig["graphql"], boolean>] | ["@vueuse/nuxt", Exclude<NuxtConfig["vueuse"], boolean>] | ["@nuxt/icon", Exclude<NuxtConfig["icon"], boolean>] | ["@nuxtjs/color-mode", Exclude<NuxtConfig["colorMode"], boolean>] | ["@nuxtjs/tailwindcss", Exclude<NuxtConfig["tailwindcss"], boolean>] | ["@nuxt/ui", Exclude<NuxtConfig["ui"], boolean>] | ["@nuxt/image", Exclude<NuxtConfig["image"], boolean>] | ["notivue/nuxt", Exclude<NuxtConfig["notivue"], boolean>] | ["@nuxthub/core", Exclude<NuxtConfig["hub"], boolean>] | ["@nuxtjs/i18n", Exclude<NuxtConfig["i18n"], boolean>] | ["@nuxt/telemetry", Exclude<NuxtConfig["telemetry"], boolean>])[],
  }
}
declare module 'nuxt/schema' {
  interface ModuleDependencies {
